import useStyles from './PrivacyModal.styles';
  ...
  return (
    <div className={classes.modal}>
      ...
      <p>
        ...
        contains types of information that is collected and recorded by pcb
        cupid and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in pcb cupid. This policy is not applicable to any
      ...
      <br />
      <p>
        pcb cupid follows a standard procedure of using log files. These files
      ...
      <br />
      <p>
        Like any other website, pcb cupid uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertisements and links that appear on pcb cupid, which are sent
      ...
      <p>
        Note that pcb cupid has no access to or control over these cookies that
