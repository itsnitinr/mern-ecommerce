  ...
  return (
    <div className={classes.modal}>
      ...
      <p>
        ...
        of Pcb cupid's Website, located at www.pcbcupid.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use pcb cupid if you do not agree to take
      ...
      <br />
      <p>
        We employ the use of cookies. By accessing pcb cupid, you agreed to use
        cookies in agreement with the Pcb cupid's Privacy Policy.{' '}
      </p>
      <p>
      ...
      <p>
        ...
        intellectual property rights are reserved. You may access this from pcb
        cupid for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from pcb cupid</li>
        <li>Sell, rent or sub-license material from pcb cupid</li>
        <li>Reproduce, duplicate or copy material from pcb cupid</li>
        <li>Redistribute content from pcb cupid</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Pcb
        cupid does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Pcb cupid,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Pcb cupid shall not be liable for
      ...
      <p>
        Pcb cupid reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Pcb cupid a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Pcb cupid; and (d) the link is
      ...
      <p>
        ...
        e-mail to Pcb cupid. Please include your name, your organization name,
      ...
      <p>
        No use of Pcb cupid's logo or other artwork will be allowed for linking
