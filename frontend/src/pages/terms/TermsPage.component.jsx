...
const TermsPage = () => {
  return (
    <>
      <PageHeader title="Terms" subtitle="Terms & Conditions" />
      <Container>
        <h2>
        ...
        <p>
          ...
          opinions. To the extent permitted by applicable laws, Pcb cupid shall
        ...
        <p>
          ...
          the hyperlink compensates the absence of Pcb cupid; and (d) the link
